...
| Name | Network| add-ons |image size| Accuracy| LB-score | LB-score-TTA| Comments |
| ------------- | -------------  | ------------- |------------- | ------------- |  ------- |  ------------| --------|
| EXP_00 | EfficientNet-B0 | | 224| 0.978539 |0.086| 0.078 |   |
| EXP_10 | xresnet50 | + Attention | 224| 0.980156 |0.090| 0.079 |   |
| EXP_10_TFL | xresnet50 | + Attention | 512| 0.979957 | 0.076| 0.074 |   |
| EXP_10_MIXUP | xresnet50 | + Attention | 224| 0.978396 | 0.082| 0.073 |   |
| EXP_10_MIXUP | xresnet50 | + Attention | 224| 0.979283 | 0.084| 0.074 | Same as above but trained a bi longer |
